...
[contrat RAG](docs/analytics-and-rag.md) pour les sorties JSONL et Markdown en
flux.
...
[matrice de compatibilité](docs/compatibility.md) avant de dépendre précisément
