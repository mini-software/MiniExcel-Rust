...
| Read configuration | Partial | Culture-aware conversion, shared-string cache controls, buffer/fast modes, and some null/empty-string behavior. Merged-cell value filling is implemented. |
