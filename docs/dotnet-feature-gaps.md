...
| Write configuration and style | Partial | Tables, shared versus inline strings, and broader cell styling remain. Rust exposes sheet name, header output/style, AutoFilter, right-to-left views, frozen rows/columns, bounded AutoWidth, body wrapping/alignment, and number formats. |
