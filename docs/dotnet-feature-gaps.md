...
| Write configuration and style | Partial | Tables, auto width, header style/alignment/wrapping, shared versus inline strings, and broader cell styling. Rust exposes sheet name, header output, AutoFilter, right-to-left views, frozen rows/columns, and number formats. |
