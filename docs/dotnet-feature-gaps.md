...
| Write configuration and style | Partial | Tables, header style/alignment/wrapping, shared versus inline strings, and broader cell styling. Rust exposes sheet name, header output, AutoFilter, right-to-left views, frozen rows/columns, bounded AutoWidth, and number formats. |
