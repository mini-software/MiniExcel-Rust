...
[contrato RAG](../analytics-and-rag.md) para la salida JSONL y Markdown en
streaming.
...
Consulta la [matriz de compatibilidad](../compatibility.md) antes de depender
...
Consulta la [matriz de compatibilidad](../compatibility.md), el [contrato de análisis/RAG](../analytics-and-rag.md) y la [guía de migración Insert](../insert-v1-migration.md).
...
El informe se escribe en `target/benchmarks/dotnet-v1-vs-rust.json`. Compara solo resultados de la misma máquina; consulta la [metodología](../dotnet-v1-query-benchmark.md).
