...
[RAG contract](../analytics-and-rag.md)を参照してください。
...
[互換性マトリクス](../compatibility.md)で正確な対応範囲を確認してください。
...
[互換性マトリクス](../compatibility.md)、[分析/RAG contract](../analytics-and-rag.md)、[Insert migration guide](../insert-v1-migration.md) を参照してください。
...
レポートは `target/benchmarks/dotnet-v1-vs-rust.json` に出力されます。同一マシンの結果だけを比較し、[測定方法](../dotnet-v1-query-benchmark.md)を参照してください。
